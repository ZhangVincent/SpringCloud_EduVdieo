package com.eduvideo.orders.api;
...
import com.eduvideo.orders.config.AlipayConfig;
...
import com.eduvideo.orders.util.SecurityUtil;
...
public class OrderController {
    ...
    public void requestpay(String payNo, HttpServletResponse httpResponse) throws IOException {
        ...
        if (payRecord == null) {
            EduVideoException.cast("请重新点击支付获取二维码");
        }
        ...
        alipayRequest.setNotifyUrl("http://www.eduvideo.cn/orders/receivenotify");//在公共参数中设置回跳和通知地址
