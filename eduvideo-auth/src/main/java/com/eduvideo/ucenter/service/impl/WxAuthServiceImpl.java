...
import com.eduvideo.ucenter.mapper.XcUserRoleMapper;
...
import com.eduvideo.ucenter.model.po.XcUserRole;
import com.eduvideo.ucenter.service.AuthService;
import com.eduvideo.ucenter.service.WxAuthService;
 ...
 * @author zkp15
 * @version 1.0
 * @description 微信登录service类
 * @date 2023/6/24 20:29
 */
@Slf4j
...
public class WxAuthServiceImpl implements AuthService, WxAuthService {
    ...
    /***
     * @description 根据令牌返回的Map<String, String>对象整合成XcUser对象，并保存用户信息到数据库，保存用户和角色的关联信息到数据库
     * @param userInfo_map
     * @return com.eduvideo.ucenter.model.po.XcUser
     * @author zkp15
     * @date 2023/6/24 20:43
     */
    @Transactional
    public XcUser addWxUser(Map userInfo_map) {
        ...
        xcUser.setUserpic(userInfo_map.get("headimgurl").toString());//这里可以进一步优化，保存网络图片到本地文件存储
