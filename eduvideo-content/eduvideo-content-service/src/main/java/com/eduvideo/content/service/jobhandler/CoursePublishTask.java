package com.eduvideo.content.service.jobhandler;

import com.eduvideo.base.exception.EduVideoException;
import com.eduvideo.content.feignclient.SearchServiceClient;
 ...
 * @author zkp15
 * @version 1.0
 * @description 分布式任务，继承MessageProcessAbstract抽象类，实现execute方法
 * @date 2023/6/22 11:11
 */
@Slf4j
@Component
public class CoursePublishTask extends MessageProcessAbstract {
    ...
    public void saveCourseIndex(MqMessage mqMessage, long courseId){
        ...
        Boolean result = saveCourseIndexToES(courseId);
        if(result){
            //保存第一阶段状态
    ...
    private Boolean saveCourseIndexToES(Long courseId) {
